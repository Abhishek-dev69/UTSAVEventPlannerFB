...
final class DashboardListViewController: UIViewController {
    ...
    private func setupHeader() {
        ...
        NSLayoutConstraint.activate([
            avatar.topAnchor.constraint(equalTo: view.safeAreaLayoutGuide.topAnchor, constant: 4),
    ...
    @objc private func segmentedChanged() {
        ...
        case 1: events = allEvents.filter { _ in true }   // implement upcoming filter
        case 2: events = allEvents.filter { _ in false }  // implement completed filter
        default: break
        }
